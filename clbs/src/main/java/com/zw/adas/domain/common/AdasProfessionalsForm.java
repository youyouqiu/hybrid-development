...
public class AdasProfessionalsForm extends BaseFormBean implements Serializable {
    ...
    @Size(max = 5, message = "【从业资格类别】长度不能超过5！", groups = { ValidGroupAdd.class, ValidGroupUpdate.class })
