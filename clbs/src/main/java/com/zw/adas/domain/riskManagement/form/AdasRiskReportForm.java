...
@Data
public class AdasRiskReportForm implements Serializable {
    private String id;
     ...
     * 预警记录
     */
    private List<AdasRiskEventAlarmReportForm> reafList = new ArrayList<>();
    ...
    private List<AdasRiskVisitReportForm> riskVisits = new ArrayList<>();
    ...
    private AdasRiskVisitReportForm dealVisit;
