...
@Data
public class AdasSetDrive implements T808MsgBody, AdasParamCommonMethod {
    ...
    protected void initBase(AdasRiskEventVehicleConfigForm revConfig) {
        //DSM、ADAS共同属性统一设置
    ...
    private void handleBaseSetting(AdasRiskEventVehicleConfigForm revConfig) {
    ...
    private void handleInitiativePhoto(AdasRiskEventVehicleConfigForm revConfig) {
    ...
    protected void calAlarmAndVoiceEnable(AdasRiskEventVehicleConfigForm revConfig, Integer pointer) {
        //预警使能
    ...
    protected void handleCmeraStrategy(AdasRiskEventVehicleConfigForm revConfig) {
