...
public class SwaggerProfessionalsForm implements Serializable {
     ...
     * 手机3
     */
    //    @Pattern(message = "【手机3】格式错误！", regexp =
    //    "^((13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\\d{8})?$",
    //    groups = {ValidGroupAdd.class,
    //            ValidGroupUpdate.class})
    ...
    //    @Pattern(message = "【紧急联系人电话】格式错误！", regexp =
    //    "^((13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\\d{8})?$",
    //    groups = {ValidGroupAdd.class,
    //            ValidGroupUpdate.class})
     ...
     * 准驾车型(用于导入导出)
     */
    @ExcelField(title = "准驾车型 (0:A1(大型客车);1:A2(牵引车);" + "2:A3(城市公交车)3:B1(中型客车);4:B2(大型货车);5:C1(小型汽车) "
        + "6:C2(小型自动挡汽车);7:C3(低速载货汽车);8:C4(三轮汽车) " + "9:D(普通三轮摩托车);10:E(普通二轮摩托车);11:F(轻便摩托车)"
        + " 12:M(轮式自行机械车);13:N(无轨电车);14:P(有轨电车))")
    @ApiParam(hidden = true)
