...
@Data
public class VehicleImportEngineeringDTO extends ImportErrorData {
    ...
    @ExcelField(title = "车主姓名", required = true)
    private String vehicleOwnerName;

    @ExcelField(title = "车主手机1", required = true)
    ...
    @ExcelField(title = "车辆子类型", required = true)
    private String vehicleSubType;

    @ExcelField(title = "自重(T)")
    private Double selfRespect;

    @ExcelField(title = "工作能力(T)")
    private Double abilityWork;

    @ExcelField(title = "工作半径(m)")
    ...
    @ExcelField(title = "初始里程(km)")
    private Double initialMileage;

    @ExcelField(title = "初始工时(h)")
