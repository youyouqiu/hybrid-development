...
public class CustomTokenServices
    ...
    protected boolean isExpired(OAuth2RefreshToken refreshToken) {
        if (refreshToken instanceof ExpiringOAuth2RefreshToken) {
            ...
            return expiringToken.getExpiration() == null || System.currentTimeMillis() > expiringToken.getExpiration()
                .getTime();
        }
        return false;
    }
    ...
    public OAuth2Authentication loadAuthentication(String accessTokenValue)
        ...
        if (accessToken == null) {
            ...
            //如果refresh_token没有过期，设置新的过期时间
            Date expiration = new Date(System.currentTimeMillis() + accessTokenValiditySeconds * 1000L);
