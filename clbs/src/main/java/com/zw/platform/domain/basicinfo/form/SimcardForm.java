...
public class SimcardForm extends BaseFormBean implements Serializable, Converter {
    ...
    @Pattern(message = "【终端手机号】输入错误，请输入合法的sim卡卡号！", regexp = "^[a-zA-Z0-9]{7,20}$", groups = {
    ...
    public static SimcardForm of(String simcardNumber, String orgId) {
    ...
    public static SimcardForm initConfigImport(ConfigImportForm config, String orgId) {
        SimcardForm form = SimcardForm.of(config.getSimcardNumber(), orgId);
    ...
    public static SimcardForm initConfigImport(ConfigTransportImportForm config, String orgId) {
        SimcardForm form = SimcardForm.of(config.getSimcardNumber(), orgId);
