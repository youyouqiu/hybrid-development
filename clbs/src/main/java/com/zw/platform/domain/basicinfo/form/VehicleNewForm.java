...
public class VehicleNewForm extends ImportErrorData implements Serializable, ConverterDateUtil {
    ...
    public static VehicleNewForm initConfigImport(ConfigImportForm config, String userName) {
        Date createDate = new Date();
        VehicleNewForm form = new VehicleNewForm();
        ...
        form.setVehicleType(VehicleConstant.VEHICLE_TYPE_DEFAULT);
        form.setCodeNum(VehicleConstant.CODE_NUM_DEFAULT);
        form.setVehType(VehicleConstant.SUB_TYPE_DEFAULT);
        form.setStandard("0");
        form.setVehicleCategoryId(VehicleConstant.VEHICLE_CATEGORY_DEFAULT);
        form.setVehicleCategoryName(VehicleConstant.VEHICLE_CATEGORY_NAME_DEFAULT);
        form.setCreateDataTime(createDate);
        form.setCreateDataTimeStr(DateFormatUtils.format(createDate, "yyyy-MM-dd"));
        form.setOperatingState(VehicleConstant.OPERATING_STATE_WORK);
    ...
    public static VehicleNewForm initConfigTransportImport(ConfigTransportImportForm config, String userName) {
        Date createDate = new Date();
        VehicleNewForm form = new VehicleNewForm();
        // String[] assignmentAndGroup = config.getGroupName().split("@");
        form.setDeviceId(config.getDeviceID());
