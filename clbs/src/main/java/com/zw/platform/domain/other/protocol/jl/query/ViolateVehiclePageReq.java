...
public class ViolateVehiclePageReq extends BaseQueryBean {
    ...
    /**
     * 违规开始时间(后台根据violateDate) 进行组装
     */
    private Date violateStartTime;

    /**
     * 违规结束时间(后台根据violateDate) 进行组装
     */
    private Date violateEndTime;
