...
import com.zw.ws.entity.adas.SetDriveAssist;
import com.zw.ws.entity.adas.SetDriverSurvey;
import lombok.Data;
...
public class RiskEventVehicleConfigForm extends BaseFormBean implements Serializable {
    ...
    public void initSendParam(SetDriverSurvey setDriverSurvey, SetDriveAssist setDriveAssist) {
        setDriverSurvey.init(this);
        setDriveAssist.init(this);
    }

    public static RiskEventVehicleConfigForm getInstance(RiskEventVehicleConfigForm config, String vehicleId) {
        RiskEventVehicleConfigForm riskEventForm = new RiskEventVehicleConfigForm();
