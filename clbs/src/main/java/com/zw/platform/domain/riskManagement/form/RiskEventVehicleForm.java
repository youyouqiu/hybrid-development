...
public class RiskEventVehicleForm extends BaseFormBean implements Serializable {
    ...
    public Map<String, String> initAndGetAssembleData(RiskEventVehicleConfigForm config) {
    ...
    public void initRiskSetting(RiskEventVehicleConfigForm setForm, String vehicleId) {
        // 风险设置
    ...
    public void initUpdateIssueSetting(RiskEventVehicleConfigForm setForm) {
        //修正下发需要
