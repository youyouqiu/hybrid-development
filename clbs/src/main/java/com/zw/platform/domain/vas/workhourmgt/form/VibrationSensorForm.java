...
public class VibrationSensorForm extends BaseFormBean {
     ...
     * 传感器厂商
     */
	@Size(max = 255, message = "【传感器厂商】长度不超过255！", groups = { ValidGroupAdd.class, ValidGroupUpdate.class })
	@ExcelField(title = "传感器厂商")
    ...
    private Integer inertiaCompEn = 1;
