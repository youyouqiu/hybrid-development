...
/**
 * @Description:主动安全参数(川冀标) (前向参数设置)
 */
@Data
@EqualsAndHashCode(callSuper = false)
public class SetDriveAssistNew extends SetDriveNew implements T808MsgBody {
    /**
     * 报警使能
     */
    ...
    static {
        ...
        String[][] alarmEnableOrder =
            {{"6407", "0,1"}, {"6405", "2,3"}, {"6402", "4,5"}, {"6401", "6,7"}, {"6404", "8,9"},
                {"6403", "10,11"}, {"6409", "16"}};
        ...
        String[][] assistAlarmParamOrder =
            {{"6407", "obstacleDistance,obstacleSpeed,obstacleVideoTime,obstacleCameraNum,obstacleCameraTime"},
                {"6405", "laneChangeTime,laneChangeSpeed,laneChangeVideoTime,laneChangeCameraNum,"
                    + "laneChangeCameraTime,laneChangeNum"},
                {"6402", "null,deviateSpeed,deviateVideoTime,deviateCameraNum,deviateCameraTime"},
                {"6401", "vehicleCollisionTime,vehicleCollisionSpeed,vehicleCollisionVideoTime,"
                    + "vehicleCollisionCameraNum,vehicleCollisionCameraTime"},
                {"6404", "pedestrianCollisionTime,pedestrianCollisionSpeed,pedestrianCollisionVideoTime,"
                ...
                {"6409",
                    "speedLimitCameraNum,speedLimitCameraTime"}
            };
    ...
    public SetDriveAssistNew(AdasParamSettingForm paramSettingForm) {
    ...
    private void handelAlarmParam(AdasAlarmParamSetting paramSetting, String key) {
        ...
        if (!"6402".equals(key) || !"6405".equals(key)) {
            //时距阈值
