...
/**
 * @Description:主动安全参数(川标) (驾驶员行为参数设置)
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ChuanDriverSurvey extends PublicParameters implements T808MsgBody {
    ...
    static {
        ...
        String[][] alarmEnableOrder =
            {{"126513", "0,1"}, {"126502", "2,3"}, {"126503", "4,5"}, {"126508", "6,7"}, {"126510", "8,9"}};
        for (String[] ints : alarmEnableOrder) {
            surveyAlarmEnableMap.put(ints[0], ints[1]);
        }
        //报警事件参数设置参数交互字段维护
        String[][] assistAlarmParamOrder =
            {{"126513", "fatigueSpeed,fatigueVideoTime,fatigueCameraNum,fatigueCameraTime"},
                {"126502", "pickUpSpeed,pickUpVideoTime,pickUpCameraNum,pickUpCameraTime"},
                {"126503", "smokingSpeed,smokingVideoTime,smokingCameraNum,smokingCameraTime"},
                {"126508", "attentionSpeed,attentionVideoTime,attentionCameraNum,attentionCameraTime"},
                {"126510", "driveDeedSpeed,driveDeedVideoTime,driveDeedCameraNum,driveDeedCameraTime"}
            };
    ...
    public ChuanDriverSurvey(AdasParamSettingForm paramSettingForm) {
