 ...
 */
@Data
public class ChuanTirePressure implements T808MsgBody {
    ...
    //126608
    public ChuanTirePressure(AdasParamSettingForm paramSettingForm, String tyreNumberName) {
