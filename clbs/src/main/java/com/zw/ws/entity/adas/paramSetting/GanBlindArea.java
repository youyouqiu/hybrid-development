...
/**
 * @Description:主动安全参数(赣标) (盲区参数设置)
 */
@Data
public class GanBlindArea implements T808MsgBody {
    ...
    public GanBlindArea(AdasParamSettingForm paramSettingForm) {
