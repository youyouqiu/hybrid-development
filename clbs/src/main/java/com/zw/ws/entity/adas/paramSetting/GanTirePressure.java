...
/**
 * @Description:主动安全参数(赣标) (胎压参数设置)
 */
@Data
public class GanTirePressure implements T808MsgBody {
    ...
    //196608
    public GanTirePressure(AdasParamSettingForm paramSettingForm, String tyreNumberName) {
