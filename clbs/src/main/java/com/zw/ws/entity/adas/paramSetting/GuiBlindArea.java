...
/**
 * @Description:主动安全参数(桂标) (盲区参数设置)
 */
@Data
public class GuiBlindArea implements T808MsgBody {
    ...
    public GuiBlindArea(AdasParamSettingForm paramSettingForm) {
