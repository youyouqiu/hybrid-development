...
/**
 * @Description:主动安全参数(沪标) (盲区参数设置)
 */
@Data
public class HuBlindArea implements T808MsgBody {
    ...
    public HuBlindArea(AdasParamSettingForm paramSettingForm) {
