...
public class HuDriverSurvey extends PublicParameters implements T808MsgBody {
    ...
    static {
        ...
        String[][] alarmEnableOrder =
            {{"206513", "0,1"}, {"206502", "2,3"}, {"206503", "4,5"}, {"206508", "6,7"}, {"206504", "8,9"}};
        for (String[] ints : alarmEnableOrder) {
            surveyAlarmEnableMap.put(ints[0], ints[1]);
        }
        //报警事件参数设置参数交互字段维护
        String[][] assistAlarmParamOrder =
            {{"206513", "fatigueSpeed,fatigueVideoTime,fatigueCameraNum,fatigueCameraTime"},
                {"206502", "pickUpSpeed,pickUpVideoTime,pickUpCameraNum,pickUpCameraTime"},
                {"206503", "smokingSpeed,smokingVideoTime,smokingCameraNum,smokingCameraTime"},
                {"206508", "attentionSpeed,attentionVideoTime,attentionCameraNum,attentionCameraTime"},
                {"206504", "driveDeedSpeed,driveDeedVideoTime,driveDeedCameraNum,driveDeedCameraTime"}
            };
    ...
    public HuDriverSurvey(AdasParamSettingForm paramSettingForm) {
