...
/**
 * @Description:主动安全参数(吉标) (前向参数设置)
 */
@Data
@EqualsAndHashCode(callSuper = false)
public class JiLinDriverAssistance extends PublicParameters implements T808MsgBody {
    /**
     * 报警使能
     */
     ...
     * 障碍物联动上传主码流视频同
     */
    private Integer obstaclePrimaryChannel = 0;

    /**
     * 障碍物联动上传子码流视频通道
     */
    private Integer obstacleSubcodeChannel = 0;

    /**
     * 障碍物联动上传抓拍通道
     */
    private Integer obstaclePhoto = 0;

    /**
     * 频繁变道联动上传主码流视频同
     */
    private Integer laneChangePrimaryChannel = 0;

    /**
     * 频繁变道联动上传子码流视频通道
     */
    private Integer laneChangeSubcodeChannel = 0;

    /**
     * 频繁变道联动上传抓拍通道
     */
    private Integer laneChangePhoto = 0;

    /**
     * 车道偏离联动上传主码流视频同
     */
    private Integer deviatePrimaryChannel = 0;

    /**
     * 车道偏离联动上传子码流视频通道
     */
    private Integer deviateSubcodeChannel = 0;

    /**
     * 车道偏离联动上传抓拍通道
     */
    private Integer deviatePhoto = 0;

    /**
     * 前向碰撞联动上传主码流视频通道
     */
    private Integer vehiclePrimaryChannel = 0;

    /**
     * 前向碰撞联动上传子码流视频通道
     */
    private Integer vehicleSubcodeChannel = 0;

    /**
     * 前向碰撞联动上传抓拍通道
     */
    private Integer vehiclePhoto = 0;

    /**
     * 行人碰撞联动上传主码流视频同
     */
    private Integer pedestrianPrimaryChannel = 0;

    /**
     * 行人碰撞联动上传子码流视频通道
     */
    private Integer pedestrianSubcodeChannel = 0;

    /**
     * 行人碰撞联动上传抓拍通道
     */
    private Integer pedestrianPhoto = 0;

    /**
     * 车距过近联动上传主码流视频同
     */
    private Integer distancePrimaryChannel = 0;

    /**
     * 车距过近联动上传子码流视频通道
     */
    private Integer distanceSubcodeChannel = 0;

    /**
     * 车距过近联动上传抓拍通道
     */
    private Integer distancePhoto = 0;
    ...
    static {
        ...
        String[][] alarmEnableOrder =
            {{"176407", "0,1"}, {"176405", "2,3"}, {"176402", "4,5"}, {"176401", "6,7"}, {"176404", "8,9"},
                {"176403", "10,11"}, {"176410", "12,13"}};
        ...
        String[][] assistAlarmParamOrder =
            {{"176407",
                "obstacleDistance,obstacleSpeed,obstacleVideoTime,obstacleCameraNum,obstacleCameraTime,null"
                    + ",obstaclePrimaryChannel,obstacleSubcodeChannel,obstaclePhoto"},
                {"176405", "laneChangeTime,laneChangeSpeed,laneChangeVideoTime,laneChangeCameraNum,"
                    + "laneChangeCameraTime,laneChangeNum,laneChangePrimaryChannel,"
                    + "laneChangeSubcodeChannel,laneChangeSubcodeChannel"},
                {"176402",
                    "null,deviateSpeed,deviateVideoTime,deviateCameraNum,deviateCameraTime,null,"
                        + "deviatePrimaryChannel,deviateSubcodeChannel,deviateSubcodeChannel"},
                {"176401", "vehicleCollisionTime,vehicleCollisionSpeed,vehicleCollisionVideoTime,"
                    + "vehicleCollisionCameraNum,vehicleCollisionCameraTime,null,vehiclePrimaryChannel,"
                    + "vehicleSubcodeChannel,vehiclePhoto"},
                {"176404", "pedestrianCollisionTime,pedestrianCollisionSpeed,pedestrianCollisionVideoTime,"
                    + "pedestrianCollisionCameraNum,pedestrianCollisionCameraTime,null,"
                    + "pedestrianPrimaryChannel,pedestrianSubcodeChannel,pedestrianPhoto"},
                {"176403",
                    "distanceMail,distanceSpeed,distanceVideoTime,distanceCameraNum,distanceCameraTime,null,"
                        + "distancePrimaryChannel,distanceSubcodeChannel,distancePhoto"},
                {"176409", "speedLimitCameraNum,speedLimitCameraTime"},
                {"176410", "null,fullTimeSpeed,fullTimeVideoTime,fullTimeCameraNum,fullTimeCameraTime"}
            };
    ...
    public JiLinDriverAssistance(AdasParamSettingForm paramSettingForm) {
    ...
    private void handelAlarmParam(AdasAlarmParamSetting paramSetting, String key) {
        ...
        //166402 车道偏离,166405 频繁变道,166410 实线变道
        if (!"176402".equals(key) || !"176405".equals(key) || !"176410".equals(key)) {
            //时距阈值
        ...
        //实线变道无码流通道设置
        if (!"176410".equals(key)) {
            //主码流
            setValIfPresent(params[6], paramSetting.getPrimaryChannel());
            //子码流
            setValIfPresent(params[7], paramSetting.getSubcodeChannel());
            //抓拍通道
            setValIfPresent(params[8], paramSetting.getCaptureChannel());
        }
        if ("176405".equals(key)) {
            //频繁变道报警判断时间段
