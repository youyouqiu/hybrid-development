...
/**
 * @Description:主动安全参数(陕标) (盲区参数设置)
 */
@Data
public class ShanBlindArea implements T808MsgBody {
    ...
    public ShanBlindArea(AdasParamSettingForm paramSettingForm) {
