...
/**
 * @Description:主动安全参数(苏标) (盲区参数设置)
 */
@Data
public class SuBlindArea implements T808MsgBody {
    ...
    public SuBlindArea(AdasParamSettingForm paramSettingForm) {
