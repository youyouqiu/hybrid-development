...
/**
 * @Description:主动安全参数(苏标) (驾驶员行为参数设置)
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class SuDriverSurvey extends PublicParameters implements T808MsgBody {
    ...
    static {
        ...
        String[][] alarmEnableOrder =
            {{"156513", "0,1"}, {"156502", "2,3"}, {"156503", "4,5"}, {"156505", "6,7"}, {"156504", "8,9"}};
        for (String[] ints : alarmEnableOrder) {
            surveyAlarmEnableMap.put(ints[0], ints[1]);
        }
        //报警事件参数设置参数交互字段维护
        String[][] assistAlarmParamOrder =
            {{"156513", "fatigueSpeed,fatigueVideoTime,fatigueCameraNum,fatigueCameraTime"},
                {"156502", "pickUpSpeed,pickUpVideoTime,pickUpCameraNum,pickUpCameraTime"},
                {"156503", "smokingSpeed,smokingVideoTime,smokingCameraNum,smokingCameraTime"},
                {"156505", "attentionSpeed,attentionVideoTime,attentionCameraNum,attentionCameraTime"},
                {"156504", "driveDeedSpeed,driveDeedVideoTime,driveDeedCameraNum,driveDeedCameraTime"}
            };
    ...
    public SuDriverSurvey(AdasParamSettingForm paramSettingForm) {
