...
/**
 * @Description:主动安全参数(苏标) (胎压参数设置)
 */
@Data
public class SuTirePressure implements T808MsgBody {
    ...
    public SuTirePressure(AdasParamSettingForm paramSettingForm, String tyreNumberName) {
