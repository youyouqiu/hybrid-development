...
/**
 * @Description:主动安全参数(湘标) (驾驶员对比参数设置)
 */
@Data
public class XiangDriverComparison implements T808MsgBody {
    ...
    public XiangDriverComparison(AdasParamSettingForm paramSettingForm) {
        for (AdasAlarmParamSetting paramSetting : paramSettingForm.getAdasAlarmParamSettings()) {
            ...
            voiceEnable = paramSetting.getVoiceBroadcastComparisonEnable();
        }
    }
