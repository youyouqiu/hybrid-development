...
/**
 * @Description:主动安全参数(粤标) (盲点检测参数设置)
 */
@Data
public class YueBlindArea implements T808MsgBody {
    ...
    public YueBlindArea(AdasParamSettingForm paramSettingForm) {
