...
/**
 * @Description:主动安全参数(粤标) (胎压参数设置)
 */
@Data
public class YueTirePressure implements T808MsgBody {
    ...
    //266601
    public YueTirePressure(AdasParamSettingForm paramSettingForm, String tyreNumberName) {
