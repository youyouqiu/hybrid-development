...
/**
 * @Description:主动安全参数(浙标) (盲区参数设置)
 */
@Data
public class ZheBlindArea implements T808MsgBody {
    ...
    public ZheBlindArea(AdasParamSettingForm paramSettingForm) {
