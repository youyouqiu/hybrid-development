...
/**
 * @Description:主动安全参数(浙标) (前向参数设置)
 */
@Data
@EqualsAndHashCode(callSuper = false)
public class ZheDriverAssistance extends PublicParameters implements T808MsgBody {
    /**
     * 报警使能
     */
    ...
    static {
        ...
        String[][] alarmEnableOrder =
            {{"166407", "0,1"}, {"166405", "2,3"}, {"166402", "4,5"}, {"166401", "6,7"}, {"166404", "8,9"},
                {"166403", "10,11"}, {"166410", "12,13"}, {"166409", "16"}};
        for (String[] ints : alarmEnableOrder) {
            assistAlarmEnableMap.put(ints[0], ints[1]);
        }
        //报警事件参数设置参数交互字段维护
        String[][] assistAlarmParamOrder =
            {{"166407", "obstacleDistance,obstacleSpeed,obstacleVideoTime,obstacleCameraNum,obstacleCameraTime"},
                {"166405", "laneChangeTime,laneChangeSpeed,laneChangeVideoTime,laneChangeCameraNum,"
                    + "laneChangeCameraTime,laneChangeNum"},
                {"166402", "null,deviateSpeed,deviateVideoTime,deviateCameraNum,deviateCameraTime"},
                {"166401", "vehicleCollisionTime,vehicleCollisionSpeed,vehicleCollisionVideoTime,"
                    + "vehicleCollisionCameraNum,vehicleCollisionCameraTime"},
                {"166404", "pedestrianCollisionTime,pedestrianCollisionSpeed,pedestrianCollisionVideoTime,"
                ...
                {"166409", "speedLimitCameraNum,speedLimitCameraTime"}
            };
    ...
    public ZheDriverAssistance(AdasParamSettingForm paramSettingForm) {
    ...
    private void handelAlarmParam(AdasAlarmParamSetting paramSetting, String key) {
        ...
        //166402 车道偏离,166405 频繁变道
        if (!"166402".equals(key) || !"166405".equals(key)) {
            //时距阈值
