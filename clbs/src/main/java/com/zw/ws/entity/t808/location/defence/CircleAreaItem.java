 ...
 * @date 2016年9月6日下午4:08:10
 */
@Data
public class CircleAreaItem implements Serializable {
    ...
    ///     区域ID
    /// </summary>
    private Integer circleAreaId;

    /// <summary>
    ///     区域属性
    /// </summary>
    private Long circleAreaProperty;
    ...
    /// </summary>
    private Integer circleAreaNameLength;
