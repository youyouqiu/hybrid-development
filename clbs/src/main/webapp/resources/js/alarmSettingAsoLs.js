(function ($, window) {
    ...
    var unpackAlarmList = JSON.parse($("#unpackAlarmList").attr("value"));
    var alarmLists = new Array(unpackAlarmList, asoPointAlarmList);
    var typeId = new Array("111");
    var vpos = new Array("1111");
    var typeClass = new Array("unpackalarm");
    alarmSettings = {
        init: function () {
            //车辆list
        ...
        //拆机报警
        addinfo: function () {
            var aPush = new Array(unpackAlarmList[0].alarmPush + "");
            var typeName = new Array("拆机报警");
            var alist = [];
            ...
            $("#home1 ul").find("li").eq("0").before(alist[0]);
        },
