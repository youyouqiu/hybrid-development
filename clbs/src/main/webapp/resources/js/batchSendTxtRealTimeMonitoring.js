...
(function (window, $) {
    ...
    window.batchSendTxt = {
        init: function () {
            ...
            $('#batchForm').closest(".modal-dialog").css("width", "60%");
        ...
        search_condition: function (event) {
            ...
            var otherParam = {'webType': 1,'queryType': 'monitor', 'type': 1, 'queryType': queryType,'devType': $('#deviceTypeVal').val()};
            if (value != '') {
        ...
        initTree: function (url, otherParam) {
            var setting = {
                ...
                callback: {
                    ...
                    onCheck: batchSendTxt.onCheckVehicle,
                    onNodeCreated: batchSendTxt.zTreeOnNodeCreated,
                }
            };
            $.fn.zTree.init($("#treeList"), setting, null);
        },
        ...
        zTreeBeforeCheck: function (treeId, treeNode) {
            ...
            if (!treeNode.checked) {
                if (treeNode.type == "group" || treeNode.type == "assignment") { //若勾选的为组织或分组
                    var zTree = $.fn.zTree.getZTreeObj("treeList"), nodes = zTree
        ...
        onCheckVehicle: function (e, treeId, treeNode) {
            ...
            if(defaultCheck){
                cheakedAll.push(currentRightClickVehicleId);
                defaultCheck = false;
            }
            ...
            for (var i = 0, l = checkedNodes.length; i < l; i++) {
                ...
                if ((item.type === "vehicle" || item.type === "people" || item.type === "thing")) {
                    ...
                    }else if(!cheakedAll.contains(item.id)){
            ...
            if (cheakedAll.length > 2000) {
                layer.msg("勾选数量上限为2000");
        ...
        sendBatchButton: function () {
            ...
            //     if (vehicleIdArr.length > TREE_MAX_CHILDREN_LENGTH) {
