...
(function ($, window) {
    ...
    ganPerState = {
        init: function () {
            ...
            for (var i=0; i<socketTypeArr.length; i++){
                ...
                //socket订阅
                ganPerState.subscribeParam(type);
                // //下发指令
                ganPerState.getDatas(sensorId);
            }
        },
        //websocket订阅
        subscribeParam: function (type) {
            webSocket.subscribe(headers, "/topic/per" + type + '_' + vid + "_Info", function (data) {
                console.log(type);
                ganPerState.getSensor0104Param(data, type);
            }, null, null);
        },
        ...
        queryF3BaseParamCall: function (result, type) {
            ...
            for (var i = 0; i < alarmData.length; i++) {
                ...
                var value = ganPerState.getAlarmStatus(item.value);
        ...
        getDatas: function (sensorID) {
            json_ajax("POST", '/clbs/adas/standard/param/getJiPeripheralInfo', "json", false, {
                ...
                "sensorID": sensorID,
                "commandType": 247,
            }, ganPerState.getF3BaseParamCall);
        },
        getF3BaseParamCall: function (data) {
            if (!data.success) {
                ...
                ganPerState.createSocket0104InfoMonitor();
            }
        },
    ...
    $(function () {
        ganPerState.init();
        //刷新
        $("#readPerStateRefresh").on("click", ganPerState.readInformationRefreshClick);
    })
})($, window);