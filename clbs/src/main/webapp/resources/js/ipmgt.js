 (function ($, window) {
    ...
    platformList = {
        ...
        init: function () {
            ...
            //表格setting
            var setting = {
                listUrl: '/clbs/m/forwardplatform/ipmgt/list',
                editUrl: '/clbs/m/forwardplatform/ipmgt/edit_',
                deleteUrl: '/clbs/m/forwardplatform/ipmgt/delete_',
                deletemoreUrl: '/clbs/m/forwardplatform/ipmgt/deletemore',
