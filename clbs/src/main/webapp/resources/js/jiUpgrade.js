    ...
    jiUpgrade = {
        ...
        sensorRemoteUpgradeClick: function (vid,sensorID,brand,type) {
            ...
            json_ajax("POST", url, "json", false, {
                ...
                "sensorID": sensorType,
                "commandType": 0xF8
            },jiUpgrade.sensorRemoteUpgradeCall);
            var url="/clbs/v/monitoring/command/getCommandParam";
            var parameter={"vid": vid,"commandType":commandType,"isRefer":true};
            json_ajax("POST",url,"json",true,parameter, jiUpgrade.getSensorRemoteUpgradeCall);
        },
        //远程升级-升级指令
        ...
        sendRemoteUpgrade:function () {
            ...
            $("#saveDefineUpgradeForm").ajaxSubmit(function (data) {
                ...
                if (data.success) {
                    ...
                    $("#UUpgradeSendStatus").attr("data-id", sendstatusname).addClass(sendstatusname).val("参数下发中");
                    jiUpgrade.createSocket0900StatusMonitor(data.msg);
        ...
        createSocket0900StatusMonitor:function (msg) {
            ...
            webSocket.subscribe(headers, "/user/topic/t808_currency_response", jiUpgrade.currencyResponse, "/app/vehicle/oil/setting", requestStrS);
            webSocket.subscribe(headers, "/user/topic/deviceReportLog", jiUpgrade.deviceReportLog, "/app/vehicle/oil/setting", requestStrS);
        },
        //远程升级-判断设备是否在线
