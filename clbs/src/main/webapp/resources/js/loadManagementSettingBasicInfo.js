(function ($, window) {
    ...
    basicInfo = {
        init: function () {
            ...
            if (sensorID == "1") {
                sensorType = 0x71;
                webSocket.subscribe(headers, "/user/topic/oil63601Info", basicInfo.getSensor0104Param, null, null);
            } else {
                webSocket.subscribe(headers, "/user/topic/oil63600Info", basicInfo.getSensor0104Param, null, null);
            }
