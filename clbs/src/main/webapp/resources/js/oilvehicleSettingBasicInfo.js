(function($,window){
	...
	basicInfo = {
		init: function(){
            ...
            if (sensorID == "42") {
            	sensorType = 0x42;
                webSocket.subscribe(headers, "/user/topic/oil63554Info", basicInfo.getSensor0104Param, null, null);
            }else {
                webSocket.subscribe(headers, "/user/topic/oil63553Info", basicInfo.getSensor0104Param, null, null);
            }
