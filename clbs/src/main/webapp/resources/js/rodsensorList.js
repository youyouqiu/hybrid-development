(function(window,$){
	...
	oilRodSensorManagement = {
		init: function(){
		    ...
		    //表格setting
		    var setting = {
		        listUrl: '/clbs/m/basicinfo/equipment/rodsensor/list',
		        editUrl: '/clbs/m/basicinfo/equipment/rodsensor/edit_',
		        deleteUrl: '/clbs/m/basicinfo/equipment/rodsensor/delete_',
		        deletemoreUrl: '/clbs/m/basicinfo/equipment/rodsensor/deletemore',
	    ...
	    delModelClick: function(){
	        ...
	        // 	json_ajax("POST", myTable.deletemoreUrl, "json", true, {'deltems':checkedList.toString()},oilRodSensorManagement.deleteMoreCallback);
	        // });
            myTable.deleteItems({
	...
	$(function(){
	    ...
	    //列表刷新
        $("#refreshTable").bind("click",oilRodSensorManagement.refreshTableClick);
	})
})(window,$)