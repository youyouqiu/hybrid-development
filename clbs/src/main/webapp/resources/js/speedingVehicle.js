    ...
    speedingVehicle = {
        ...
        columnRender: function () {
            ...
            var makeText = function (index, text) {
                ...
                return "<li><label><input type=\"checkbox\"  " + checkedStr + " class=\"toggle-vis1\" data-column=\"" + index + "\" />" + text + "</label></li>"
            };
            menu_text += makeText(1, '监控对象');
        ...
        initTable: function () {
            ...
            //表格setting
            var setting = {
                listUrl: "/clbs/cb/cbReportManagement/speedingStatistics/vehicle/speedingStatisticsList",
        ...
        exportMonitor: function () {
            ...
            var url = "/clbs/cb/cbReportManagement/speedingStatistics/vehicle/exportVehListData";
        ...
        exportMonitorDeatil: function () {
            ...
            var paramer = {
                time: curMonthTime,
                vehicleIds: curSelectmonitorId,
                fuzzyQueryParam: '',
                module: '车辆超速统计报表'
            };
            var url = "/clbs/cb/cbReportManagement/speedingStatistics/vehicle/exportVehSpeedDetailsData";
            json_ajax("post", url, "json", true, paramer, function (result) {
                if (result.success) {
                    layer.confirm(exportTitle, {
                        title: '操作确认',
        ...
        getVehicleDetailInfo: function () {
            ...
            var infoUrl = '/clbs/cb/cbReportManagement/speedingStatistics/vehicle/rankInfo';
            json_ajax("post", infoUrl, "json", true, ajaxDataParam, function (result) {
                if (result.success) {
                    ...
                    var noStr = '-';
                    $('#monitorOver50PerCentNum').html(data.over50PerCentNum === undefined ? noStr : data.over50PerCentNum);
                    $('#monitorCent20To50PerNum').html(data.cent20To50PerNum === undefined ? noStr : data.cent20To50PerNum);
                    $('#monitorLess20PerUnder').html(data.less20PerNum === undefined ? noStr : data.less20PerNum);
            ...
            // 获取详情图表数据
            var url = '/clbs/cb/cbReportManagement/speedingStatistics/vehicle/upSpeedGraphicalInfo';
        ...
        initDetailTable: function () {
            ...
            var columns = [
                ...
                {
                    "data": "alarmStartAddress",
                    "class": "text-center",
                    /*render: function (data, type, row, meta) {
                        return '<a onclick="speedingVehicle.getAddress(this,\'' + data + '\')">' + data + '</a>';
                    }*/
                },
                {
                    "data": "alarmEndAddress",
                    "class": "text-center",
                    /*render: function (data, type, row, meta) {
                        return '<a onclick="speedingVehicle.getAddress(this,\'' + data + '\')">' + data + '</a>';
                    }*/
            ...
            //ajax参数
            var ajaxDataParamFun = function (d) {
                d.vehicleIds = curSelectmonitorId;
                d.time = curMonthTime;
            };
            //表格setting
            var setting = {
                listUrl: "/clbs/cb/cbReportManagement/speedingStatistics/vehicle/upSpeedInfoList",
                columnDefs: columnDefs, //表格列定义
                columns: columns, //表格列
        ...
        trendEchart: function (echartData, element) {
            ...
            var option = {
                ...
                color: ['#c74540', '#ff9f7f', '#ffdb5c', '#37a2da', '#fe18fe', '#ff0000'],
                grid: {
                    top: 60,
                    right: 50,
                },
