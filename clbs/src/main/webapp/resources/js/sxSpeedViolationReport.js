(function (window, $) {
    ...
    speedSearch = {
        ...
        inquireClick: function (number) {
            ...
            var url = "/clbs/sx/sxReportManagement/sxSpeedViolationReport/list";
            ...
            myTable = $(table).DataTable({
                ...
                "drawCallback": function (settings) {
                    ...
                    if (alarmLocation === "加载中..." && !getAddressStatus) {
                        speedSearch.getAddress(newStopLoc);
                    }
                },
                "order": [
                    [0, null]
