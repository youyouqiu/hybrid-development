   ...
   winchStatisticsList = {
		init: function(){
	        ...
	        var setting = {
	            async: {
	            	...
	            	url: winchStatisticsList.getTreeUrl,
	                type: "post",
	                enable: true,
	                autoParam: ["id"],
	                dataType: "json",
	                ...
	                dataFilter: winchStatisticsList.ajaxDataFilter
	            },
	            check: {
	                enable: true,
	                chkStyle: "checkbox",
	            ...
	            callback: {
	                beforeClick: winchStatisticsList.beforeClickVehicle,
	                onCheck: winchStatisticsList.onCheckVehicle,
	                beforeCheck: winchStatisticsList.zTreeBeforeCheck,
					onExpand: winchStatisticsList.zTreeOnExpand,
					//beforeAsync: winchStatisticsList.zTreeBeforeAsync,
					onAsyncSuccess: winchStatisticsList.zTreeOnAsyncSuccess,
					onNodeCreated: winchStatisticsList.zTreeOnNodeCreated
	            }
	        };
           ...
           if (param == null || param == undefined || param == '') {
               ...
               var querySetting = {
                   async: {
                       ...
                       dataFilter: winchStatisticsList.ajaxQueryDataFilter
                   },
                   check: {
                       enable: true,
                       chkStyle: "checkbox",
       ...
       ajaxQueryDataFilter: function (treeId, parentNode, responseData) {
        ...
        zTreeOnAsyncSuccess: function(event, treeId, treeNode, msg){
            ...
            winchStatisticsList.getCharSelect(treeObj);
        },
        ...
        onCheckVehicle: function(e, treeId, treeNode){
        	...
        	if(treeNode.type != "assignment" || (treeNode.type == "assignment" && treeNode.children != undefined)){
        		winchStatisticsList.getCharSelect(zTree);
        	}
            crrentSubV = [];
        ...
        getCharSelect: function (treeObj) {
			...
			$("#groupSelect,#groupSelectSpan").bind("click",winchStatisticsList.showMenu);
	...
	$(function(){
		$('input').inputClear();
		winchStatisticsList.init();
	    $("#endTime").bind("click",winchStatisticsList.endTimeClick);
        ...
        $('input').inputClear().on('onClearEvent',function(e,data){
            ...
            if(id == 'groupSelect'){
                ...
                winchStatisticsList.searchVehicleTree(param);
            };
        });
