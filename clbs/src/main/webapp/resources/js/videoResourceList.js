    ...
    resourceList = {
        ...
        getIcoTreeUrl: function (treeId, treeNode) {
            ...
            if (treeNode == null) {
                ...
                return "/clbs/m/functionconfig/fence/bindfence/new/putMonitorByAssign?assignmentId=" + treeNode.id + "&isChecked=" + treeNode.checked + "&monitorType=monitor" + "&webType=2" + status;
            }
        },
                    ...
                    if (data.obj.type !== "0") {
                        ...
                        if (ftp != null) {
                            ...
                            for (j = 0; j < ftpresourceListBeans.length; j++) {
                                ...
                                FTPList = [channlNumer, startTime, endTime, alarmType, fileSize, url, name, channlNumer];
         ...
         * @author yangbike
         */
        terminalVideoPlayback: function () {
            if (!videoPluginSelect) {
                videoControlPlugin.play();
            ...
            if (videoPlayDeviceLists.elements.length > 0) {
                ...
                // 开始对视频进行订阅
                resourceList.terminalVideoSub(pluginSendData);
            }
        },

        // 终端视频订阅
        terminalVideoSub: function (info, playType) {
            var multiple; //播放倍数
            var remoteMode; //回放方式
        ...
        ftpListGet: function () {
            ...
            if (selectSearchType === 1) {
                ...
                var searchStartTimess = new XDate(firstDay).toString('yyyy-MM-dd');
                var searchEndTime = new XDate(lastDay).toString('yyyy-MM-dd');
                startTime = searchStartTimess + " 00:00:00";
                endTime = searchEndTime + " 23:59:59";
            }
            var alarmType = alarmTen;
            if (alarmType === "") {
