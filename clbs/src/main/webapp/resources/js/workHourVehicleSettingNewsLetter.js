(function($,window){
	...
	newsletter = {
		init: function(){
            ...
            if(sensorID=="80"){
                /*62785  62786*/
                webSocket.subscribe(headers, "/user/topic/oil62848Info", newsletter.getSensor0104Param, null, null);
            }
            if (sensorID == "81") {
            	sensorType = 0x81;
                webSocket.subscribe(headers, "/user/topic/oil62849Info", newsletter.getSensor0104Param, null, null);
            }
