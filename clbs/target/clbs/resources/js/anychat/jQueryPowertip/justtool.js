...
(function($) {
    ...
    justTools.prototype = {
        ...
        close:function(){
            this.obj.remove();
            if(this.set.onRemove){
                this.set.onRemove.call(this);
            }
        },
        ...
        setEvent:function(){
            var self = this;
            // var newEvents = self.set.events.split(',');
            // for (var i = 0; i < newEvents.length; i++) {
            //     if(newEvents[i] =="click" || newEvents[i] =="onclick"){
            ...
            //         });
            //     }
            //     if(newEvents[i] =="mouseover" || newEvents[i] =="onmouseover" || newEvents[i] =="mouseenter"){
    ...
    $.fn.justToolsTip = function(options){
        var defaults = {
            ...
            no: '鍙栨秷',
            //delay: 1000,
            onYes: function(){}, //杩斿洖ture锛屽叧闂璽ools
            onNo: function(){},
            onRemove:null
        }
        this.each(function(){
