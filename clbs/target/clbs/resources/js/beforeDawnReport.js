(function (window, $) {
    ...
    speedSearch = {
        ...
        inquireClick: function (number) {
            ...
            var url = "/clbs/sx/sxReportManagement/beforeDawnReport/list";
        ...
        exportAlarm: function () {
            ...
            var url = "/clbs/sx/sxReportManagement/beforeDawnReport/export";
        ...
        goBack: function (GeocoderResult) {
            ...
            for (var i = 0; i < dataLength; i++) {
                if (msgArray[i] != undefined) {
                    $dataTableTbody.children("tr:nth-child(" + (startIndex + 1) + ")").children("td:nth-child(10)").text(msgArray[i][0]);
                    $dataTableTbody.children("tr:nth-child(" + (startIndex + 1) + ")").children("td:nth-child(11)").text(msgArray[i][1]);
                    startIndex++;
                }
            }
        },
        ...
        getAddress: function (startStr, endStr) {
            ...
            for (var i = 0; i < dataLength; i++) {
                num++;
                var alarmLocation = $dataTableTbody.children("tr:nth-child(" + (i + 1) + ")").children("td:nth-child(10)").text();
        ...
        getTable: function (table) {
            myTable = $(table).DataTable({
                ...
                "drawCallback": function (settings) {
                    ...
                    var $dataTableTbody = $("#dataTable tbody");
                    var alarmStartLocation = $dataTableTbody.children("tr:last-child").children("td:nth-child(10)").text();
                    var alarmEndLocation = $dataTableTbody.children("tr:last-child").children("td:nth-child(11)").text();
                    //报警位置进行逆地址解析
