(function (window, $) {
    ...
    addChatGroup = {
        //提交
        doSubmits: function () {
            addChatGroup.hideErrorMsg();
            $("#input_user_ids").val(allVid);
            if (!addChatGroup.validates()) {
                return false;
            }
            if (allVid == undefined || allVid.toString().length == 0) {
                addChatGroup.showErrorMsg(chatGroupUserNull, "groupSelect3");
                return false;
            }
            ...
            $("#addForm").ajaxSubmit(function (data) {
                ...
                if (data.success) {
                    ...
                    if (data.msg.toString().indexOf("名称") > -1) {
                        addChatGroup.showErrorMsg(data.msg, "groupName");
        ...
        init: function () {
            var setting = {
                async: {
                    ...
                    autoParam: ["id"],
                    dataType: "json",
                    dataFilter: addChatGroup.ajaxDataFilter
                },
                check: {
                    enable: true,
                    chkStyle: "checkbox",
                ...
                callback: {
                    beforeClick: addChatGroup.beforeClickVehicle,
                    onCheck: addChatGroup.onCheckVehicle,
                    onExpand: addChatGroup.zTreeOnExpand,
                    onNodeCreated: addChatGroup.zTreeOnNodeCreated
                }
            };
        ...
        onCheckVehicle: function (e, treeId, treeNode) {
            ...
            // }
            addChatGroup.getCheckedNodes();
            addChatGroup.getCharSelect(zTree);
        },
        // 获取到选择的节点
    ...
    $(function () {
        ...
        $("#doSubmits").bind("click", addChatGroup.doSubmits);
    })
})(window, $)