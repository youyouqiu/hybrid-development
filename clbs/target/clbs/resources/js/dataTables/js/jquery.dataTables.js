...
(/** @lends <global> */function (window, document, undefined) {
                ...
                if (formatters === aSort.length) {
                    ...
                    displayMaster.sort(function (a, b) {
                        ...
                        for (k = 0; k < len; k++) {
                            ...
                            test = x < y ? -1 : x > y ? 1 : 0;
                            if (typeof oSettings.customSort === 'function') {
                                test = oSettings.customSort(x, y, sort.dir, sort.col, test);
                            }
                            if (test !== 0) {
        ...
        function _fnBindAction(n, oData, fn) {
            $(n)
                .bind('click.DT', oData, function (e) {
                    ...
                    //切换页码,取消表格中的复选框勾选状态
                    $(n).closest('.row').siblings('table').find('input:checkbox').attr('checked', false);
	 ...
	 *       }
        ...
        _api_register('jumpTo', function (number) {
            this.page(number).draw(false)
        });
