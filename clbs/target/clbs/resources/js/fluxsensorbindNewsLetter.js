(function($,window){
	...
	newsletter = {
		init: function(){
            ...
            // 订阅
            webSocket.subscribe(headers, "/user/topic/oil62789Info", newsletter.getSensor0104Param, null,null);
...
//            webSocket.subscribe(headers, "/user/" + msg.userName + "/oil62789Info", newsletter.getSensor0104Param, "/app/vehicle/oil/setting", requestStrS);
        },
        //获取通讯参数值
        ...
        readCommunicationRefreshClick:  function () {
            newsletter.initF5ParamCall();
            var url = '/clbs/v/oilmgt/fluxsensorbind/getF3Param';
            json_ajax("POST", url, "json", false, {
                "vid": vid,
                "sensorID": 0x45,
                "commandType": 0xF5
