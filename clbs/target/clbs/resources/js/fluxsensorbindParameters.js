(function($,window){
	...
	parameters = {
        ...
        privateParameterSettingsSend: function () {
            ...
            // 订阅
            webSocket.subscribe(headers, "/user/topic/t808_currency_response", parameters.currencyResponse, null, null);
            webSocket.subscribe(headers, "/user/topic/deviceReportLog", parameters.deviceReportLog, null, null);
            var url = '/clbs/v/oilmgt/fluxsensorbind/getF3PrivateParam';
...
//            webSocket.subscribe(headers, "/user/" + msg.userName + "/t808_currency_response", parameters.currencyResponse, "/app/vehicle/oil/setting", requestStrS);
//            webSocket.subscribe(headers, "/user/" + msg.userName + "/deviceReportLog", parameters.deviceReportLog, "/app/vehicle/oil/setting", requestStrS);
        },
        //处理获取设备下发的结果
