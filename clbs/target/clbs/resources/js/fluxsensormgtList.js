(function(window,$){
	...
	flowSensorManagement = {
		init: function(){
		    ...
		    //表格setting
		    var setting = {
		        listUrl : '/clbs/v/oilmgt/fluxsensormgt/list',
		        editUrl : '/clbs/v/oilmgt/fluxsensormgt/edit_',
		        deleteUrl : '/clbs/v/oilmgt/fluxsensormgt/delete_',
		        deletemoreUrl : '/clbs/v/oilmgt/fluxsensormgt/deletemore',
