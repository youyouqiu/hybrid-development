...
(function($) {
    ...
    JustTools.prototype = {
        ...
        init:function(){
            ...
            var evt = window.event ? $.event.fix(window.event) : null;
            var e = arguments.callee.caller.caller.caller.caller.caller.arguments[0] || evt;
            if (e && e.type){
    ...
    $.fn.justToolsTip = function(options){
        var defaults = {
            ...
            no: '取消',
            //delay: 1000,
            onYes: function(){}, //返回true，关闭tools
            onNo: function(){},
            onRemove: function () {} // 移除时触发
        };
        this.each(function(){
