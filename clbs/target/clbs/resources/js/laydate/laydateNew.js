...
;!(function() {
    ...
    var e = window.layui && layui.define
        ...
        link: function(e, a, i) {
            if (n.path) {
                ...
                typeof a == "function" && !(function c() {
                    return ++d > 80 ? window.console && console.error("laydate.css: Invalid") : void (parseInt(t.getStyle(document.getElementById(l), "width")) === 1989 ? a() : setTimeout(c, 100))
                }())
            }
        }
    }
        ...
        , C = function(e) {
        for (var t = 0, n = typeof e == "object" ? [e] : (this.selector = e,
    ...
    C.prototype = [],
        ...
        w.extend = function() {
            ...
            for (t[0] = typeof t[0] == "object" ? t[0] : {}; e < t.length; e++)
                {typeof t[e] == "object" && n(t[0], t[e]);}
            return t[0]
        }
        ,
        w.ie = (function() {
        ...
        C.prototype.append = function(e) {
            return this.each(function(t, n) {
                typeof e == "object" ? n.appendChild(e) : n.innerHTML = n.innerHTML + e
            })
        }
        ,
        ...
        T.prototype.init = function() {
            ...
            t.format === i.date && (t.format = i[t.type]),
                ...
                w.each(e.format, function(t, a) {
                    var i = new RegExp(n).test(a) ? "\\d{" + (function() {
                        return new RegExp(n).test(e.format[t === 0 ? t + 1 : t - 1] || "") ? /^yyyy|y$/.test(a) ? 4 : a.length : /^yyyy$/.test(a) ? "1,4" : /^y$/.test(a) ? "1,308" : "1,2"
                    }()) + "}" : "\\" + a;
                    e.EXP_IF = e.EXP_IF + i,
            ...
            e.isInput(t.elem[0]) || t.trigger === "focus" && (t.trigger = "click"),
            t.elem.attr("lay-key") || (t.elem.attr("lay-key", e.index),
                t.eventElem.attr("lay-key", e.index)),
                t.mark = w.extend({}, t.calendar && t.lang === "cn" ? {
                    "0-1-1": "元旦",
                    "0-2-14": "情人",
                    "0-3-8": "妇女",
                    "0-3-12": "植树",
        ...
        T.prototype.render = function() {
            var e = this
                ...
                , i = e.elem = w.elem("div", {
                id: e.elemID,
                "class": ["layui-laydate", t.range ? " layui-laydate-range" : "", a ? " " + c : "", t.theme && t.theme !== "default" && !/^#/.test(t.theme) ? " laydate-theme-" + t.theme : ""].join("")
            })
                , r = e.elemMain = []
                , o = e.elemHeader = []
                , s = e.elemCont = []
            ...
            if (t.zIndex && (i.style.zIndex = t.zIndex),
                ...
                w(d).html(function() {
                    var e = []
                        , i = [];
                    return t.type === "datetime" && e.push('<span lay-type="datetime" class="laydate-btns-time">' + n.timeTips + "</span>"),
                        w.each(t.btns, function(e, r) {
                            var o = n.tools[r] || "btn";
                            t.range && r === "now" || (a && r === "clear" && (o = t.lang === "cn" ? "重置" : "Reset"),
            ...
            typeof t.ready == "function" && t.ready(w.extend({}, t.dateTime, {
        ...
        T.prototype.position = function() {
            ...
            t.position && (e.elem.style.position = t.position),
                e.elem.style.left = d + (t.position === "fixed" ? 0 : o(1)) + "px",
                e.elem.style.top = c + (t.position === "fixed" ? 0 : o()) + "px"
        }
        ,
        ...
        T.prototype.checkDate = function(e) {
            var t, a, i = this, r = (new Date,
                ...
                i.isInput(s) ? s.value : r.position === "static" ? "" : s.innerHTML), c = function(e) {
            ...
            return e === "limit" ? (c(o),
                i) : (l = l || r.value,
            typeof l == "string" && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")),
            i.startState && !i.endState && (delete i.startState,
                i.endState = !0),
                typeof l == "string" && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "),
        ...
        T.prototype.mark = function(e, t) {
            ...
            return w.each(i.mark, function(e, a) {
                var i = e.split("-");
                i[0] != t[0] && i[0] != 0 || i[1] != t[1] && i[1] != 0 || i[2] != t[2] || (n = a || t[2])
            }),
        ...
        T.prototype.calendar = function(e) {
            var t, a, i, r = this, s = r.config, l = e || s.dateTime, c = new Date, m = r.lang(), u = s.type !== "date" && s.type !== "datetime", h = e ? 1 : 0, y = w(r.table[h]).find("td"), f = w(r.elemHeader[h][2]).find("span");
            ...
            r.firstDate || (r.firstDate = w.extend({}, l)),
                ...
                s.lang === "cn" ? (w(f[0]).attr("lay-type", "year").html(l.year + "年"),
            ...
            u && (s.range && (e ? r.endDate = r.endDate || {
                year: l.year + (s.type === "year" ? 1 : 0),
                month: l.month + (s.type === "month" ? 0 : -1)
            ...
            e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]],
                ...
                s.type === "time" ? r.setBtnStatus("时间", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))),
        ...
        T.prototype.list = function(e, t) {
            var n = this
                ...
                , i = a.dateTime
                , r = n.lang()
                , l = a.range && a.type !== "date" && a.type !== "datetime"
                , d = w.elem("ul", {
                "class": m + " " + {
                    ...
                    w(d).find("li").on("click", function() {
                        ...
                        if (!w(this).hasClass(s)) {
                            if (t === 0)
                                ...
                                var c = e === "year" ? n.getAsYM(r, T[1] - 1, "sub") : n.getAsYM(T[0], r, "sub");
                                w.extend(i, {
                                    year: c[0],
                                    month: c[1]
                                })
                            }
                            a.type === "year" || a.type === "month" ? (w(d).find("." + o).removeClass(o),
                                w(this).addClass(o),
                            a.type === "month" && e === "year" && (n.listYM[t][0] = r,
                    ...
                    w(d).find("ol").each(function(e) {
                        ...
                        w(t).find("li").on("click", function() {
                            ...
                            w(this).hasClass(s) || (a.range ? n[x][C[e]] = r : i[C[e]] = r,
                                ...
                                E(),
                                k(),
                            (n.endDate || a.type === "time") && n.done(null, "change"),
                                n.setBtnStatus())
                        })
                    })
            }
        ...
        T.prototype.setBtnStatus = function(e, t, n) {
            var a, i = this, r = i.config, o = w(i.footer).find(g), d = r.range && r.type !== "date" && r.type !== "time";
            d && (t = t || i.startDate,
                n = n || i.endDate,
                a = i.newDate(t).getTime() > i.newDate(n).getTime(),
                i.limit(null, t) || i.limit(null, n) ? o.addClass(s) : o[a ? "addClass" : "removeClass"](s),
            e && a && i.hint(typeof e == "string" ? l.replace(/日期/g, e) : l))
        }
        ,
        ...
        T.prototype.setValue = function(e) {
            ...
            return n.position === "static" || w(a)[i](e || ""),
                this
        }
        ,
        ...
        T.prototype.done = function(e, t) {
            ...
            return w.each([i, r], function(e, t) {
                ...
                e = e || [n.parse(), i, r],
            typeof a[t || "done"] == "function" && a[t || "done"].apply(a, e),
                n
        }
        ,
        T.prototype.choose = function(e) {
            ...
            if (r = {
                ...
                {if (n.range) {
                    ...
                    {n.position === "static" ? (l(!0),
                        t.calendar().done().done(null, "change")) : n.type === "date" ? (l(!0),
                        t.setValue(t.parse()).remove().done()) : n.type === "datetime" && (l(!0),
            ...
            var n = this
                ...
                confirm: function() {
                    if (a.range) {
                        ...
                        if (w(e).hasClass(s))
                            {return n.hint(a.type === "time" ? l.replace(/日期/g, "时间") : l)}
        ...
        T.prototype.change = function(e) {
            var t = this
                , n = t.config
                , a = n.dateTime
                , i = n.range && (n.type === "year" || n.type === "month")
                , r = t.elemCont[e || 0]
                , o = t.listYM[e]
                , s = function(s) {
        ...
        T.prototype.events = function() {
            ...
            t.elem[0] && !t.elem[0].eventHandler && (n(t.elem, "bind"),
                ...
                w(document).on("click", function(n) {
                    ...
                    t.keyCode === 13 && w("#" + e.elemID)[0] && e.elemID === T.thisElem && (t.preventDefault(),
