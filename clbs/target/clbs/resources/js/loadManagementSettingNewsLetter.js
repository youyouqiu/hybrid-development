(function($,window){
	...
	newsletter = {
		init: function(){
            ...
            if(sensorID=="70"){
                /*62785  62786*/
                webSocket.subscribe(headers, "/user/topic/oil62832Info", newsletter.getSensor0104Param, null, null);
            }
            if (sensorID == "71") {
            	sensorType = 0x71;
                webSocket.subscribe(headers, "/user/topic/oil62833Info", newsletter.getSensor0104Param, null, null);
            }
