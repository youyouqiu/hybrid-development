(function(window,$){
    ...
    mainObj = {
        ...
        init: function(){
            ...
            //表格setting
            var setting = {
                listUrl: '/clbs/v/loadmgt/loadsensor/list',
                editUrl: '/clbs/v/loadmgt/loadsensor/edit_',
                deleteUrl: '/clbs/v/loadmgt/loadsensor/delete_',
                deletemoreUrl: '/clbs/v/loadmgt/loadsensor/deletemore',
