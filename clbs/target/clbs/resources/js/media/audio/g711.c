...
EMSCRIPTEN_KEEPALIVE void decodeG711a(short* amp, unsigned char* data, int len)
{
...
EMSCRIPTEN_KEEPALIVE void decodeG711u(short* amp, unsigned char* data, int len)
{
	unsigned char code = 0;
	int sl = 0;
	for(int i = 0; i < len; ++i)
...
EMSCRIPTEN_KEEPALIVE void encodeG711a(unsigned char* g711_data, short* amp, int len)
{
    for (int i = 0; i < len; ++i)
	{
...
EMSCRIPTEN_KEEPALIVE void encodeG711u(unsigned char* g711_data, short* amp, int len)
{
    for(int i = 0; i < len; ++i)
	{
