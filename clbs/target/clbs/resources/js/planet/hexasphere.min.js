function PRingBufferGeometry(e, t, a, i, r, n) {
    ...
    var o, s, l, d = (a + 1) * (i + 1), u = a * i * 2 * 3, h = new THREE.BufferAttribute(new (u > 65535 ? Uint32Array : Uint16Array)(u),1), c = new THREE.BufferAttribute(new Float32Array(3 * d),3), f = new THREE.BufferAttribute(new Float32Array(3 * d),3), p = new THREE.BufferAttribute(new Float32Array(2 * d),2), v = 0, m = 0, E = e, g = (t - e) / i, T = new THREE.Vector3, w = new THREE.Vector2, x = 1 / i, R = 1 / a;
    for (s = 0; s <= i; s++) {
        for (l = 0; l <= a; l++)
            o = r + l / a * n,
            T.x = E * Math.cos(o),
            T.y = E * Math.sin(o),
            c.setXYZ(v, T.x, T.y, T.z),
            f.setXYZ(v, 0, 0, 1),
            w.x = l * R,
            w.y = s * x,
            p.setXY(v, w.x, w.y),
...
function Planet(e, t, a, i) {
    ...
    function u(t) {
        ...
        t.briefs_text = PlanetData.hasLocationAnyBriefTexts(B, !0);
        var i = [t];
        if (kaspersky.getHexaspherePopup) {
            var r = kaspersky.getHexaspherePopup(i, h);
            U = r.element,
            z = r.close;
            var n = $(U);
            n.on("mouseleave", a)
    ...
    function h(t) {
        ...
        a = "brief" === i.type ? i.brief_id : langUrl + "locations/" + t.location_id,
        c.state = c.ANIMATED,
        e.controls.detach(),
    ...
    p.add(g);
    var T = this.static_container = new THREE.Object3D;
    p.add(T),
    T.matrixAutoUpdate = !1;
    this.textureLoader = new THREE.TextureLoader;
    this.planet_color = 0x293157,
    ...
    c.data = t,
    t.countries_by_id = {};
    for (var w = 0; w < t.countries.length; w++) {
        var x = t.countries[w];
        t.countries_by_id[x.country_id] = x
    }
    t.locations_by_id = {};
    for (var w = 0; w < t.locations.length; w++) {
        var x = t.locations[w];
    ...
    this.getLocationBriefs = function(e, t) {
        var a = c.data.locations_by_id[e]
          , r = a.brief_list;
        if (r)
            return void (!1 != !!r[PlanetData.YEAR_ID] && t(r[PlanetData.YEAR_ID].briefs));
        i({
            location_id: e
        }).done(function(e) {
            r = a.brief_list = e,
            !1 != !!r[PlanetData.YEAR_ID] && t(r[PlanetData.YEAR_ID].briefs)
        })
    }
    ,
...
function PlanetLocations(e) {
    ...
    for (var d = .8, u = new THREE.MeshBasicMaterial({
        transparent: !0,
        opacity: 0,
        color: new THREE.Color(0x0ed60a),
        ...
        for (var d, c = new THREE.Geometry, f = new THREE.Geometry, n = 0; n < r.length; n++) {
            ...
            if (!1 != !!o.years[t]) {
                ...
                if (g.briefs) {
                    ...
                    var T = e.googlePosToUV(o.planet_u, o.planet_v);
                    Utils.setFromSpherical(m, T.v, T.u, p.position),
                    p.lookAt(E),
                    p.updateMatrix(),
                    p.updateMatrixWorld(),
                    d = g.works ? c : f,
    ...
    var g = new THREE.MeshBasicMaterial({
      ...
      , T = g;
    T.map = e.textureLoader.load(PlanetData.textures_path + "lightray.jpg"),
    T.map.wrapT = THREE.ClampToEdgeWrapping;
    var w = g.clone();
    w.map = e.textureLoader.load(PlanetData.textures_path + "lightray_yellow.jpg")
}
function PlanetPointed(e) {
    ...
    for (var a = [], i = 0; i < 2; i++) {
        ...
        // 颜色：大陆上的点
        r.color = new THREE.Color(0x1d376a),
        r.map = t,
        r.depthWrite = !1,
        r.transparent = !0,
        r.opacity = 0,
    ...
    this.init = function(t) {
        ...
        for (var n = 0; n < r.length; n++) {
            ...
            v.material = a[n];
            var T = v.mesh = new THREE.Points(m,v.material);
            T.matrixAutoUpdate = !1,
            i.add(T)
        }
        e.radius;
        s = new THREE.MeshBasicMaterial({
            ...
            opacity: 0,
            // 颜色：海里的六边形
            color: new THREE.Color(0x385ca3),
            blending: THREE.AdditiveBlending,
            depthWrite: !1
        });
        for (var w, x, R, H, A = Utils.createHexagon(.18, !1, s, .025), b = new THREE.Geometry, M = .01, P = (Math.PI,
...
THREE.SMAAPass = function(e, t) {
    ...
    void 0 === THREE.SMAAShader && console.error("THREE.SMAAPass relies on THREE.SMAAShader"),
    ...
    function d(e) {
        if (!1 !== h.enabled) {
            ...
            case 2:
                ...
                g.set(0, n),
                T.subVectors(g, E),
                T.y > 0 ? s(-h.zoomSpeed) : T.y < 0 && s(h.zoomSpeed),
                E.copy(g)
            }
        }
    }
...
Planet.prototype.drawPoints = function(e) {
    ...
    var t = new THREE.SphereGeometry(1.1 * e,66,44)
      , a = new THREE.XRayMaterial({
        ...
        alphaProportion: .5,
        // 颜色：外太空圈
        color: new THREE.Color(0x282d44),
        opacity: 1,
        gridOffsetSpeed: .6
    })
...
Planet.prototype.drawParticles = function(e) {
    // 颜色：空气中粒子
    for (var t = new Float32Array(1800), a = new THREE.Color(0x576a8d), i = new THREE.Spherical, r = new THREE.Vector3, n = 0; n < 600; n++) {
        var o = 3 * n;
...
PlanetContour = function(e) {
    ...
    var r = .8
      ...
      // 颜色：大陆轮廓
    o.color = new THREE.Color(0x274c8c),
    o.fog = !1,
    o.transparent = !0,
...
var PlanetData = function() {
    var e = this;
    this.textures_path = "/clbs/resources/img/planet/",
    this.YEAR = null,
    this.YEAR_ID = null,
    this.years = {
        2030: {
    ...
    return this.hasLocationAnyBriefs = function(t, a) {
        if (!0 === a && t.years[e.YEAR_ID])
            return t.years[e.YEAR_ID].briefs;
        if (void 0 !== a && t.years[a])
    ...
    this.hasLocationAnyBriefTexts = function(t, a) {
        if (!0 === a)
            return t.years[e.YEAR_ID].briefs_text;
        if (void 0 !== a)
            return t.years[a].briefs_text;
        for (var i in t.years) {
            if (t.years[i].briefs)
                return t.years[i].briefs_text
        }
        return 0
    }
    ,
