(function (window, $) {
    ...
    var transduserNumber = 2;//传感器设置界面数量
    var flag = false;
    ...
    TemperatureSettings = {
        ...
        efficacy: function (number) {
            ...
            if (alarmDown == undefined || alarmDown === "" || isNaN(alarmDown) || !reg.test(alarmUp) || alarmDown < -100 || alarmDown > 200) {
        ...
        doSubmit: function () {
            ...
            var data = {"sensorList": sensorList, "vid": vehicleId, "type": 1,'resubmitToken':value};
            if (flag) {
                sensorList.push("");
        ...
        updateShow: function () {
            ...
            TemperatureSettings.consult(vehicle);
        },
        clearInput: function () {
            var type = "";
            for (var i = 1; i < 6; i++) {
    ...
    $(function () {
    	$('input').inputClear();
        TemperatureSettings.updateShow();
        TemperatureSettings.init();
        TemperatureSettings.activeShow();
