(function (window, $) {
    ...
    tirePressureSettingEdit = {
        init: function () {
            ...
            $("#brands").bsSuggest({
                ...
                json_ajax("POST", url, "json", false, data, tirePressureSettingEdit.consult);     //发送请求
        ...
        doSubmit: function () {
            if (!tirePressureSettingEdit.validates()) return;
            tirePressureSettingEdit.hideErrorMsg();
            ...
            if (lowVoltageThreshold > normalTirePressure) {
                tirePressureSettingEdit.showErrorMsg("低压阈值不能大于正常胎压值，请确认！", 'lowVoltageThreshold');
                return;
            }
            if (highVoltageThreshold < normalTirePressure) {
                tirePressureSettingEdit.showErrorMsg("高压阈值不能小于正常胎压值，请确认！", 'highVoltageThreshold');
                return;
            }

            var url = '/clbs/v/tyrepressure/setting/edit';
            ...
            address_submit("POST", url, "json", false, data, true, tirePressureSettingEdit.callBack);     //发送请求
        },
    ...
    $(function () {
        $('input').inputClear();
        tirePressureSettingEdit.init();
        $("#doSubmit").bind("click", tirePressureSettingEdit.doSubmit);
