(function (window, $) {
  ...
  editVehicleInsurance = {
          ...
          insuranceId: {
            ...
            remote: {
              ...
              dataFilter: function (data, type) {
                ...
                var oldInsuranceId = $("#oldInsuranceId").val();
                if (insuranceId == oldInsuranceId) {
                  return true;
                } else {
                  if (data == "true") {
                    return true;
    ...
    doSubmits: function () {
      if (editVehicleInsurance.validates()) {
  ...
  $(function () {
    editVehicleInsurance.init();
    editVehicleInsurance.getBrandList();
    ...
    $("#editDoSubmits").bind("click", editVehicleInsurance.doSubmits);
  })
})(window, $)